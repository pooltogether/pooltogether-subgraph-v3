...
export class CompoundPrizePoolProxyFactory extends ethereum.SmartContract {
  static bind(address: Address): CompoundPrizePoolProxyFactory {
    return new CompoundPrizePoolProxyFactory(

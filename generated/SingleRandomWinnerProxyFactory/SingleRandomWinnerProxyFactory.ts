...
export class SingleRandomWinnerProxyFactory extends ethereum.SmartContract {
  static bind(address: Address): SingleRandomWinnerProxyFactory {
    return new SingleRandomWinnerProxyFactory(

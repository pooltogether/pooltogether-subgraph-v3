...
export class ERC777UpgradeSafe extends ethereum.SmartContract {
  static bind(address: Address): ERC777UpgradeSafe {
    return new ERC777UpgradeSafe("ERC777UpgradeSafe", address);
  }
